  ...
  app.get('/orientation', function(req, res) {
    ...
    setInterval(function() {
      IMU.getValue((err, data) => {
        var datares = {"acc":data.accel, "gyro":data.gyro,"compass":data.compass,"fusion":data.fusionPose, "temp":data.temp,"pressure":data.pressure, "humid": data.humid}
